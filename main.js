...
var author$project$Main$alphas = elm$core$Dict$fromList(
	A2(
		elm$core$List$map,
		function (_char) {
...
var author$project$Main$update = F2(
	function (msg, aModel) {
		switch (msg.$) {
			...
			default:
				var letter = msg.a;
				var otherLetter = msg.b;
				var toMap = function () {
					var _n1 = elm$core$String$uncons(otherLetter);
					if (_n1.$ === 'Just') {
						var _n2 = _n1.a;
						var aChar = _n2.a;
						return aChar;
...
var author$project$Main$UpdateMapping = F2(
	function (a, b) {
		return {$: 'UpdateMapping', a: a, b: b};
	});
var elm$core$Basics$False = {$: 'False'};
var elm$core$Basics$eq = _Utils_equal;
var author$project$Main$anySelected = F2(
	function (aChar, selected) {
		if (selected.$ === 'Just') {
			var selChar = selected.a;
			return _Utils_eq(aChar, selChar);
		} else {
			return false;
		}
	});
...
var author$project$Main$letterView = F3(
	function (_char, selected, mapping) {
		var mappedChar = function () {
			var _n1 = A2(elm$core$Dict$get, _char, mapping);
			if (_n1.$ === 'Just') {
				if (' ' === _n1.a.valueOf()) {
					return '';
				} else {
					var aChar = _n1.a;
					return elm$core$String$fromChar(aChar);
				}
			} else {
				return '';
			}
		...
		var events = _List_fromArray(
			[
				...
				author$project$Main$Highlight(elm$core$Maybe$Nothing))
			]);
		...
		var classAttrs = A2(author$project$Main$anySelected, _char, selected) ? _List_fromArray(
			[
				elm$html$Html$Attributes$class('highlight letter-space')
			]) : _List_fromArray(
			[
				elm$html$Html$Attributes$class('letter-space')
			]);
		var attrs = _Utils_ap(classAttrs, events);
		return A2(
			elm$html$Html$div,
			attrs,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$html$Html$Attributes$class('proposed')
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									...
									elm$html$Html$Attributes$value(mappedChar),
									elm$html$Html$Events$onInput(
									author$project$Main$UpdateMapping(_char)),
					...
					_List_fromArray(
						[
							elm$html$Html$text(displayChar)
						]))
				]));
	});
var author$project$Main$punctView = function (_char) {
	var punctClass = function () {
	...
	return A2(
		...
		_List_fromArray(
			[
				elm$html$Html$Attributes$class('punct-space')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$class(punctClass)
					]),
				_List_fromArray(
					[
						elm$html$Html$text(
...
var author$project$Main$charView = F3(
	function (_char, selected, mapping) {
		return elm$core$Char$isUpper(_char) ? A3(author$project$Main$letterView, _char, selected, mapping) : author$project$Main$punctView(_char);
	});
var author$project$Main$wordView = F3(
	function (word, selected, mapping) {
		...
		return A2(
			...
			A2(
				elm$core$List$map,
				function (_char) {
					return A3(author$project$Main$charView, _char, selected, mapping);
				},
				chars));
	});
var author$project$Main$puzzleBoardView = function (model_) {
	...
	return A2(
		...
		_List_fromArray(
			[
				elm$html$Html$Attributes$class('puzzle-board clearfix')
			]),
		A2(
			elm$core$List$map,
			function (word) {
...
var author$project$Main$EditPuzzle = function (a) {
	return {$: 'EditPuzzle', a: a};
};
...
var author$project$Main$puzzleResetView = A2(
	elm$html$Html$button,
	_List_fromArray(
		[
			elm$html$Html$Events$onClick(
			author$project$Main$EditPuzzle('')),
